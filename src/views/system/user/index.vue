  ...
  <div class="p-2">
                ...
                <el-dropdown class="mt-[1px]">
                  ...
                  <template #dropdown>
                    <el-dropdown-menu>
                      ...
                      <el-dropdown-item @click="handleExport" icon="Download"> 导出用户数据</el-dropdown-item>
                    </el-dropdown-menu>
                  </template>
                </el-dropdown>
              </el-col>
    ...
    <el-dialog ref="formDialogRef" :title="dialog.title" v-model="dialog.visible" width="600px" append-to-body @close="closeDialog">
      <el-form :model="form" :rules="rules" ref="userFormRef" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="电话号码" prop="userName">
              <el-input v-model="form.userName" placeholder="请输入电话号码" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="账号名称">
              <el-input v-model="form.nickName" placeholder="请输入账号名称" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="支付宝" prop="zfb">
              <el-input v-model="form.zfb" placeholder="请输入支付宝账号" maxlength="50" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="微信" prop="wx">
              <el-input v-model="form.wx" placeholder="请输入微信号" maxlength="50" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
const submitForm = () => {
  userFormRef.value?.validate(async (valid: boolean) => {
    if (valid) {
      // 如果不是设计师就设置为
      if(form.value.roleIds[0]!="1787375831862013953"){
        form.value.isDesigner = "0";
      }else{
        form.value.isDesigner = "1";
      }
      form.value.phonenumber =form.value.userName
